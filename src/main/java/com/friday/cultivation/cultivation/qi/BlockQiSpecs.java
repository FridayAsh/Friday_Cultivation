...
public final class BlockQiSpecs {
    private static final Map<Block, BlockQiSpec> SPECS = new IdentityHashMap<Block, BlockQiSpec>();
    ...
    private static void applyHardcodedDefaults() {
        ...
        BlockQiSpecs.put((Block)ModBlocks.LOW_SPIRIT_STONE_ORE.get(), BlockQiSpec.of(QiElement.PURE, 2000, 5.0, 0.1));
        BlockQiSpecs.put((Block)ModBlocks.MID_SPIRIT_STONE_ORE.get(), BlockQiSpec.of(QiElement.PURE, 4000, 10.0, 0.15));
        BlockQiSpecs.put((Block)ModBlocks.HIGH_SPIRIT_STONE_ORE.get(), BlockQiSpec.of(QiElement.PURE, 8000, 20.0, 0.2));
        BlockQiSpecs.put((Block)ModBlocks.SUPREME_SPIRIT_STONE_ORE.get(), BlockQiSpec.of(QiElement.PURE, 20000, 50.0, 0.3));
        BlockQiSpecs.put((Block)ModBlocks.SPIRIT_VEIN_SPRING.get(), BlockQiSpec.of(QiElement.PURE, 50000, 80.0, 0.45));
        BlockQiSpecs.put((Block)ModBlocks.CUSHION.get(), BlockQiSpecs.wood_strong());
    }
