...
public enum AlchemyRank {
    ...
    private AlchemyRank(String id, ChatFormatting color, int xpToNext, int[] probabilities) {
        this.id = id;
        this.color = color;
    ...
    public Component displayName() {
        return Component.translatable((String)("alchemy_rank.friday_cultivation." + this.id));
    }
