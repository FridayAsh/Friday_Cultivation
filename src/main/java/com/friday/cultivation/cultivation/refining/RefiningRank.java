...
public enum RefiningRank {
    APPRENTICE("apprentice", ChatFormatting.GRAY, 100, new int[]{80, 10, 4, 3, 2, 1, 0}),
    RANK_1("rank_1", ChatFormatting.WHITE, 250, new int[]{60, 25, 8, 4, 2, 1, 0}),
    RANK_2("rank_2", ChatFormatting.WHITE, 500, new int[]{45, 35, 12, 5, 2, 1, 0}),
    RANK_3("rank_3", ChatFormatting.AQUA, 1000, new int[]{30, 40, 18, 8, 3, 1, 0}),
    RANK_4("rank_4", ChatFormatting.AQUA, 2000, new int[]{20, 35, 28, 12, 4, 1, 0}),
    RANK_5("rank_5", ChatFormatting.GREEN, 4000, new int[]{12, 25, 35, 20, 6, 2, 0}),
