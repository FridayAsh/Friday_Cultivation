...
public final class ModItems {
    ...
    public static final RegistryObject<Item> XUAN_IRON_SWORD_SAGE;
    ...
    public static final RegistryObject<Item> QING_MU_SWORD_SAGE;
    ...
    public static final RegistryObject<Item> CHI_YAN_SWORD_SAGE;
    ...
    public static final RegistryObject<Item> HAN_BING_SWORD_SAGE;
    ...
    private static int[] realmEggColors(Realm realm) {
        ...
        switch (realm) {
            ...
            case HALF_SAGE: {
                ...
                nArray = nArrayHalfSage;
                nArrayHalfSage[1] = 3289650;
                break;
            }
            case SAGE: {
                int[] nArraySage = new int[2];
                nArraySage[0] = 10197724;
                nArray = nArraySage;
                nArraySage[1] = 3289650;
                break;
            }
            case HALF_EMPEROR: {
                int[] nArrayHalfEmperor = new int[2];
                nArrayHalfEmperor[0] = 16744576;
                nArray = nArrayHalfEmperor;
                nArrayHalfEmperor[1] = 32896;
                break;
            }
            case LOOSE_IMMORTAL: {
    ...
    static {
        ...
        XUAN_IRON_SWORD_SAGE = ITEMS.register("xuan_iron_sword_sage", () -> new XuanIronSwordItem(ItemTier.SAGE, 22, 60));
        ...
        QING_MU_SWORD_SAGE = ITEMS.register("qing_mu_sword_sage", () -> new QingMuSwordItem(ItemTier.SAGE, 22, 60));
        ...
        CHI_YAN_SWORD_SAGE = ITEMS.register("chi_yan_sword_sage", () -> new ChiYanSwordItem(ItemTier.SAGE, 22, 60));
