...
/**
 * 阵法类型（严格照搬原模组 com.xiaoxiang.cultivation.cultivation.qi.formation.FormationType）
 * 7种阵法：QI_GATHERING, SECT_PROTECTION, WITHER_GROWTH, REJUVENATION, FLIGHT_BAN, MAZE, FARM_HARVEST
 */
public enum FormationType {
    ...
    WITHER_GROWTH("wither_growth", 1) {
        ...
        @Override
        public boolean drainsByCoveredBlocks() { return true; }
    ...
    FormationType(String id, int minFlagsRequired) {
        this.id = id;
    ...
    public int minFlagsRequired() { return this.minFlagsRequired; }
    ...
    public boolean drainsByCoveredBlocks() { return false; }
    public double growthMultiplier(ItemTier flagTier) { return 1.0; }
    public int rejuvenationAmplifier(ItemTier flagTier) { return -1; }
    public boolean flightBanPullsAirborneHostiles(ItemTier flagTier) { return false; }
    public int flightBanSlownessAmplifier(ItemTier flagTier) { return -1; }
    public boolean mazeAppliesNausea(ItemTier flagTier) { return false; }
    public int mazeTeleportDelayTicks(ItemTier flagTier) { return -1; }
    public int harvestIntervalTicks(ItemTier flagTier) { return -1; }
    public int harvestBatchSize(ItemTier flagTier) { return 0; }
    public boolean harvestDoublesDrops(ItemTier flagTier) { return false; }

    public long sectProtectionQiPerDamage(ItemTier flagTier) {
        throw new UnsupportedOperationException("Only SECT_PROTECTION supports this query");
    }
    public double sectProtectionBarrierDamagePerSecond(ItemTier flagTier) { return 0.0; }
}