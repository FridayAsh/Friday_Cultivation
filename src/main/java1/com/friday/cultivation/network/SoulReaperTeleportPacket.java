...
/**
 * 勾魂令传送请求包（客户端→服务端）— 完整复刻原模组 SoulReaperTeleportPacket。
 * 玩家在目标列表界面点击"传送"按钮时发送，服务端调用 SoulReaperOrderHandler.teleportToTarget。
 */
public class SoulReaperTeleportPacket {
    ...
    public UUID targetId() { return this.targetId; }
}
