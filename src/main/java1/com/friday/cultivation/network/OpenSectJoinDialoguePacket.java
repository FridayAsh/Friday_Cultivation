...
/**
 * 打开加入宗门对话框包 — 严格 1:1 复刻原 mod com.xiaoxiang.cultivation.network.OpenSectJoinDialoguePacket。
 * 服务端 → 客户端：携带目标 NPC 信息与宗门快照，客户端打开入宗对话。
 */
public class OpenSectJoinDialoguePacket {
    ...
    public static void handle(OpenSectJoinDialoguePacket msg, Supplier<NetworkEvent.Context> ctxSup) {
        ...
        ctx.enqueueWork(() -> DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> SectClientHooks.openJoinDialogue(msg.targetEntityId, msg.sectName, msg.npcName, msg.snapshot)));
