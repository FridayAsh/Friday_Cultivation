...
/**
 * 客户端→服务端: 选择身份/灵根/体质
 * 复刻自原模组 com.xiaoxiang.cultivation.network.ChooseOriginPacket
 */
public class ChooseOriginPacket {
    ...
    public static void handle(ChooseOriginPacket msg, Supplier<NetworkEvent.Context> ctxSup) {
        ...
        ctx.enqueueWork(() -> {
            ...
            IdentityDrawHandler.handleChooseOrigin(
                    player, msg.random, msg.identityId,
                    msg.spiritRootId, msg.physiqueId, msg.reconfigureMode
            );
        });
