...
/**
 * 武器光晕装饰器（完全照搬原模组 com.xiaoxiang.cultivation.client.WeaponGlowDecorator）。
 * 手持灵器（TieredWeapon）时物品栏图标显示品阶色光晕。
 */
public class WeaponGlowDecorator implements IItemDecorator {
