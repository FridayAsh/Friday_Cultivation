...
extends AbstractButton {
    ...
    public void renderWidget(@NotNull GuiGraphics gfx, int mouseX, int mouseY, float partial) {
        boolean hover;
        boolean bl = hover = this.isHovered() && !this.selected && this.isRevealed();
        if (hover) {
            float scale = 1.03f;
        ...
        if (!this.isRevealed()) {
            ...
            int borderColor = this.selected ? -2056128 : (this.isHovered() ? -3626888 : rarityRgb);
            ...
            List items = this.identity.starterItems();
            ...
            if (!items.isEmpty()) {
                ...
                for (int i = 0; i < maxShow; ++i) {
                    ...
                    DrawCardWidget.drawItemScaled(gfx, (ItemStack)items.get(i), ix, iconY, (float)iconSize / 16.0f);
    ...
    public void updateWidgetNarration(@NotNull NarrationElementOutput output) {
        // 1.20.1: AbstractButton 默认已有 narration 输出
    }
}
