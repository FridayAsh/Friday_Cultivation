...
/**
 * 炼器Ghost渲染器 — 完整复刻原模组 RefiningGhostRenderer。
 * 当玩家切换 ghost 模式时，以半透明渲染炼器炉结构中缺失的方块，便于玩家查看还需放置哪些方块。
 *
 * 注意：依赖 GhostBufferSource（后续 Phase 创建）和 RefiningFurnaceStructure.missingBlocks。
 */
