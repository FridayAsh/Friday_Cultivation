...
public class RefiningMenu extends AbstractContainerMenu {
    ...
    public RefiningMenu(int containerId, Inventory inv, BlockPos corePos) {
        ...
        this.blockEntityRef = be instanceof RefiningCoreBlockEntity rce ? rce : null;
    ...
    private void addSlots(Inventory inv) {
        ...
        for (int col = 0; col < 9; ++col) {
            this.addSlot(new Slot((Container) inv, col, 98 + col * 18, 180));
        }
    }
